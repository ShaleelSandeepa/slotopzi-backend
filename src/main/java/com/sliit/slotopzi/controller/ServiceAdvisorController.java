...
public class ServiceAdvisorController {
    ...
    public ResponseEntity addNewRepair(@RequestBody AddNewRepairsRequest addNewRepairsRequest){
        ...
        System.out.println("addNewRepairsRequest: "+addNewRepairsRequest.getPaymentType());
        System.out.println("addNewRepairsRequest: "+addNewRepairsRequest.getVin());
        System.out.println("addNewRepairsRequest: "+addNewRepairsRequest.getUserId());
